...
public class ApiEntity extends ApiValue implements Entity {
	...
	public static void putProperty(final JSONObject json, String propertyCode, ApiStatement apiStatement) {
		putToNamedMapArray(json, KEY_CLAIMS, propertyCode, apiStatement.jsonObject);
	}
