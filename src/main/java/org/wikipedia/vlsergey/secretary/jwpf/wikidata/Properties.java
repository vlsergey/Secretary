...
public interface Properties {
	...
	EntityId ADMINISTRATIVE_UNIT = EntityId.property(131);

	EntityId CATEGORY_FOR_PEOPLE_BORN_HERE = EntityId.property(1464);

	EntityId CATEGORY_FOR_PEOPLE_DIED_HERE = EntityId.property(1465);

	EntityId COMMONS_CATEGORY = EntityId.property(373);
	...
	EntityId GENDER = EntityId.property(21);
	...
	EntityId NATIONALITY = EntityId.property(27);

	EntityId OFFICIAL_WEBSITE = EntityId.property(856);

	EntityId PART_OF = EntityId.property(361);
	...
	EntityId TITLE = EntityId.property(357);
